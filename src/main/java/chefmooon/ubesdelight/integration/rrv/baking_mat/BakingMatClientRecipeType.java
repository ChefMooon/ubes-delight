...
public class BakingMatClientRecipeType implements ReliableClientRecipeType {

    public static final BakingMatClientRecipeType INSTANCE = new BakingMatClientRecipeType();
    @Override
    ...
    public ItemStack getIcon() {
        return new ItemStack(UbesDelightItems.BAKING_MAT_BAMBOO.get());
    }

    @Override
    public List<ItemStack> getCraftReferences() {
        return List.of(UbesDelightItems.BAKING_MAT_BAMBOO.get().getDefaultInstance());
    }
}
