...
import chefmooon.ubesdelight.integration.jei.UDRecipeTypes;
...
public class BakingMatRecipeCategory implements IRecipeCategory<BakingMatRecipe> {
    ...
    @Override
    public RecipeType<BakingMatRecipe> getRecipeType() {
        return UDRecipeTypes.BAKING_MAT;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BakingMatRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(BakingMatRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
