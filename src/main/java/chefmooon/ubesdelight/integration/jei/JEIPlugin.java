...
public class JEIPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(UDRecipeTypes.BAKING_MAT, recipes.getBakingMatRecipes());
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(UbesDelightItems.BAKING_MAT_BAMBOO.get()), UDRecipeTypes.BAKING_MAT);
    }
}
