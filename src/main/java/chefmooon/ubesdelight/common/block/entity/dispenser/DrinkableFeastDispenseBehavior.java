...
public class DrinkableFeastDispenseBehavior extends OptionalDispenseItemBehavior {
    ...
    public static void register() {
        DispenserBlock.registerBehavior(UbesDelightItems.HALO_HALO.get(), new DrinkableFeastDispenseBehavior());
        DispenserBlock.registerBehavior(UbesDelightItems.MILK_TEA_UBE.get(), new DrinkableFeastDispenseBehavior());
    }
}
