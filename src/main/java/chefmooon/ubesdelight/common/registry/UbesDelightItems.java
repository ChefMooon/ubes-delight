...
public class UbesDelightItems {
    ...
    public static Supplier<Item> registerItemWithTab(final String location, final Supplier<Item> supplier) {
        Supplier<Item> item = ITEMS.register(location, supplier);
        CREATIVE_TAB_ITEMS.add(item);
        return item;
    }

    public static Supplier<Item> registerItem(final String location, final Supplier<Item> supplier) {
        return ITEMS.register(location, supplier);
    }
