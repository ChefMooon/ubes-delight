package chefmooon.ubesdelight.common.tag;
...
public class CommonTags {
    ...
    public static final TagKey<Biome> C_IS_JUNGLE = TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("c", "is_jungle"));
