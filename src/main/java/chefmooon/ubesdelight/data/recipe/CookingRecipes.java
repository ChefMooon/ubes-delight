...
public class CookingRecipes extends UDRecipes {
    ...
    public static void register(RecipeOutput exporter) {
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(UbesDelightItems.CONDENSED_MILK_BOTTLE.get(), 1, 50, .0F)
                .addIngredient(Ingredient.of(CommonTags.C_TEA_INGREDIENTS_SWEET_WEAK))
                .addIngredient(Ingredient.of(MILK_BOTTLE))
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(UbesDelightItems.CONDENSED_MILK_BOTTLE.get(), 4, 200, .0F)
                .addIngredient(Ingredient.of(CommonTags.C_TEA_INGREDIENTS_SWEET_WEAK), 4)
        ...
        CookingPotRecipeBuilder.cookingPotRecipe(UbesDelightItems.MILK_POWDER.get(), 1, 200,  0.2F)
                ...
                .unlockedBy(RecipeUtil.hasItemTag(Tags.Items.DRINKS_MILK), RecipeProvider.has(Tags.Items.DRINKS_MILK))
                .setRecipeBookTab(CookingPotRecipeBookTab.DRINKS)
