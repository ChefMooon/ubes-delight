...
public class AdvancmentGenerator extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer) {
        ...
        AdvancementHolder ubeMaster = getAdvancement(placeKalan, UbesDelightItems.UBE_CAKE_SLICE.get(), "ube_master", AdvancementType.CHALLENGE, true, true, false)
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.COOKIE_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.COOKIE_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.UBE_CAKE_SLICE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.UBE_CAKE_SLICE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.POLVORONE_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.POLVORONE_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.ENSAYMADA_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.ENSAYMADA_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.PANDESAL_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.PANDESAL_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.HOPIA_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.HOPIA_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.MILK_TEA_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.MILK_TEA_UBE.get()))
        ...
        AdvancementHolder udMaster = getAdvancement(placeDrinkableFeast, UbesDelightItems.UBE_CAKE.get(), "ud_master", AdvancementType.CHALLENGE, true, true, false)
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.MILK_TEA_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.MILK_TEA_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.HALO_HALO.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.HALO_HALO.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.SINANGAG.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.SINANGAG.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.KINILAW.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.KINILAW.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.LUMPIA.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.LUMPIA.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.TOCINO.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.TOCINO.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.CHICKEN_INASAL.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.CHICKEN_INASAL.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.CHICKEN_INASAL_RICE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.CHICKEN_INASAL_RICE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.TOSILOG.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.TOSILOG.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.BANGSILOG.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.BANGSILOG.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.SISIG.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.SISIG.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.BULALO.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.BULALO.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.ARROZ_CALDO.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.ARROZ_CALDO.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.MECHADO.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.MECHADO.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.COOKIE_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.COOKIE_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.COOKIE_GINGER.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.COOKIE_GINGER.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.LECHE_FLAN.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.LECHE_FLAN.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.UBE_CAKE_SLICE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.UBE_CAKE_SLICE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.POLVORONE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.POLVORONE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.POLVORONE_PINIPIG.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.POLVORONE_PINIPIG.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.POLVORONE_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.POLVORONE_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.POLVORONE_CC.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.POLVORONE_CC.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.PANDESAL.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.PANDESAL.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.PANDESAL_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.PANDESAL_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.ENSAYMADA.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.ENSAYMADA.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.ENSAYMADA_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.ENSAYMADA_UBE.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.HOPIA_MUNGGO.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.HOPIA_MUNGGO.get()))
                .addCriterion(RecipeProvider.getItemName(UbesDelightItems.HOPIA_UBE.get()), ConsumeItemTrigger.TriggerInstance.usedItem(UbesDelightItems.HOPIA_UBE.get()))
                .rewards(AdvancementRewards.Builder.experience(200))
