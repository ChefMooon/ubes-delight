...
import chefmooon.ubesdelight.common.utility.UbesDelightTextureSlots;
...
public class BlockModelGenerator {
    ...
    public static void generateBlockStateModels(BlockModelGenerators blockStateModelGenerator) {
        ...
        ResourceLocation UBE_STAGE0_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.UBE_CROP.get(), "_stage0");
        ...
        ResourceLocation UBE_STAGE1_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.UBE_CROP.get(), "_stage1");
        ResourceLocation UBE_STAGE1 = UbesDelightModels.TEMPLATE_ODD_CROP.create(UBE_STAGE1_LOCATION,
                ...
                blockStateModelGenerator.modelOutput);
        ResourceLocation UBE_STAGE2_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.UBE_CROP.get(), "_stage2");
        ResourceLocation UBE_STAGE2 = UbesDelightModels.TEMPLATE_ODD_CROP.create(UBE_STAGE2_LOCATION,
                ...
                blockStateModelGenerator.modelOutput);
        ResourceLocation UBE_STAGE3_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.UBE_CROP.get(), "_stage3");
        ResourceLocation UBE_STAGE3 = UbesDelightModels.TEMPLATE_ODD_CROP.create(UBE_STAGE3_LOCATION,
                ...
                blockStateModelGenerator.modelOutput);
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(UbesDelightBlocks.UBE_CROP.get())
        ...
        ResourceLocation GARLIC_STAGE0 = UbesDelightModels.TEMPLATE_COMPLEX_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage0"),
                TextureMapping.singleSlot(UbesDelightTextureSlots.CROSS_V1, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage0_v1"))
                        .put(UbesDelightTextureSlots.CROSS_V2, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage0_v2")),
                blockStateModelGenerator.modelOutput);
        ResourceLocation GARLIC_STAGE1 = UbesDelightModels.TEMPLATE_COMPLEX_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage1"),
                TextureMapping.singleSlot(UbesDelightTextureSlots.CROSS_V1, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage1_v1"))
                        .put(UbesDelightTextureSlots.CROSS_V2, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage1_v2")),
                blockStateModelGenerator.modelOutput);
        ResourceLocation GARLIC_STAGE2 = UbesDelightModels.TEMPLATE_COMPLEX_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage2"),
                TextureMapping.singleSlot(UbesDelightTextureSlots.CROSS_V1, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage2_v1"))
                        .put(UbesDelightTextureSlots.CROSS_V2, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage2_v2")),
                blockStateModelGenerator.modelOutput);
        ResourceLocation GARLIC_STAGE3 = UbesDelightModels.TEMPLATE_COMPLEX_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage3"),
                TextureMapping.singleSlot(UbesDelightTextureSlots.CROSS_V1, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage3_v1"))
                        .put(UbesDelightTextureSlots.CROSS_V2, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GARLIC_CROP.get(), "_stage3_v2")),
                blockStateModelGenerator.modelOutput);
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(UbesDelightBlocks.GARLIC_CROP.get())
        ...
        ResourceLocation GINGER_STAGE0 = UbesDelightModels.TEMPLATE_COMPLEX_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage0"),
                TextureMapping.singleSlot(UbesDelightTextureSlots.CROSS_V1, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage0_v1"))
                        .put(UbesDelightTextureSlots.CROSS_V2, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage0_v2")),
                blockStateModelGenerator.modelOutput);
        ResourceLocation GINGER_STAGE1 = UbesDelightModels.TEMPLATE_COMPLEX_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage1"),
                TextureMapping.singleSlot(UbesDelightTextureSlots.CROSS_V1, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage1_v1"))
                        .put(UbesDelightTextureSlots.CROSS_V2, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage1_v2")),
                blockStateModelGenerator.modelOutput);
        ResourceLocation GINGER_STAGE2 = UbesDelightModels.TEMPLATE_COMPLEX_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage2"),
                TextureMapping.singleSlot(UbesDelightTextureSlots.CROSS_V1, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage2_v1"))
                        .put(UbesDelightTextureSlots.CROSS_V2, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage2_v2")),
                blockStateModelGenerator.modelOutput);
        ResourceLocation GINGER_STAGE3 = UbesDelightModels.TEMPLATE_COMPLEX_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage3"),
                TextureMapping.singleSlot(UbesDelightTextureSlots.CROSS_V1, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage3_v1"))
                        .put(UbesDelightTextureSlots.CROSS_V2, ModelLocationUtils.getModelLocation(UbesDelightBlocks.GINGER_CROP.get(), "_stage3_v2")),
                blockStateModelGenerator.modelOutput);
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(UbesDelightBlocks.GINGER_CROP.get())
        ...
        ResourceLocation LEMONGRASS_STAGE0 = UbesDelightModels.TEMPLATE_CROP_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get(), "_stage0"),
                TextureMapping.singleSlot(TextureSlot.CROSS, ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get(), "_stage0")), blockStateModelGenerator.modelOutput);
        ResourceLocation LEMONGRASS_STAGE1 = UbesDelightModels.TEMPLATE_CROP_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get(), "_stage1"),
                TextureMapping.singleSlot(TextureSlot.CROSS, ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get(), "_stage1")), blockStateModelGenerator.modelOutput);
        ResourceLocation LEMONGRASS_STAGE2 = UbesDelightModels.TEMPLATE_CROP_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get(), "_stage2"),
                TextureMapping.singleSlot(TextureSlot.CROSS, ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get(), "_stage2")), blockStateModelGenerator.modelOutput);
        ResourceLocation LEMONGRASS_STAGE3 = UbesDelightModels.TEMPLATE_CROP_CROSS.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get(), "_stage3"),
                TextureMapping.singleSlot(TextureSlot.CROSS, ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get(), "_stage3")), blockStateModelGenerator.modelOutput);
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(UbesDelightBlocks.LEMONGRASS_LEAF_CROP.get())
        ...
        ResourceLocation LEMONGRASS_STALK_STAGE0_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_STALK_CROP.get(), "_stage0");
        ...
        ResourceLocation LEMONGRASS_STALK_STAGE1_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_STALK_CROP.get(), "_stage1");
        ...
        ResourceLocation LEMONGRASS_STALK_STAGE2_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_STALK_CROP.get(), "_stage2");
        ...
        ResourceLocation LEMONGRASS_STALK_STAGE3_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_STALK_CROP.get(), "_stage3");
        ...
        ResourceLocation LEMONGRASS_STALK_STAGE4_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_STALK_CROP.get(), "_stage4");
        ...
        ResourceLocation LEMONGRASS_STALK_STAGE5_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_STALK_CROP.get(), "_stage5");
        ...
        ResourceLocation LEMONGRASS_STALK_SUPPORTING_LOCATION = ModelLocationUtils.getModelLocation(UbesDelightBlocks.LEMONGRASS_STALK_CROP.get(), "_supporting");
        ...
        TextureMapping textureMapKalan = TextureMapping.singleSlot(TextureSlot.SIDE, ModelLocationUtils.getModelLocation(UbesDelightBlocks.KALAN.get(), "_side"))
        ...
        TextureMapping textureMapKalanOn = TextureMapping.singleSlot(TextureSlot.SIDE, ModelLocationUtils.getModelLocation(UbesDelightBlocks.KALAN.get(), "_side_on"))
                .put(TextureSlot.BOTTOM, TextureMapping.getBlockTexture(UbesDelightBlocks.KALAN.get(), "_bottom"))
                .put(TextureSlot.TOP, TextureMapping.getBlockTexture(UbesDelightBlocks.KALAN.get(), "_top_on"));
        ResourceLocation kalan = ModelTemplates.CUBE_BOTTOM_TOP.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.KALAN.get()), textureMapKalan, blockStateModelGenerator.modelOutput);
        ResourceLocation kalan_on = ModelTemplates.CUBE_BOTTOM_TOP.create(ModelLocationUtils.getModelLocation(UbesDelightBlocks.KALAN.get(), "_on"), textureMapKalanOn, blockStateModelGenerator.modelOutput);
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(UbesDelightBlocks.KALAN.get())
...
//                ));
        ...
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(UbesDelightBlocks.LEAF_FEAST.get())
                .with(BlockModelGenerators.createHorizontalFacingDispatch())
        ...
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(UbesDelightBlocks.UNIVERSAL_LEAF_FEAST.get())
                        .with(BlockModelGenerators.createHorizontalFacingDispatch())
                        .with(PropertyDispatch.property(LeafFeastBlock.LEAF_FEAST_TYPE)
                                .select(LeafFeastTypes.BASE, Variant.variant().with(VariantProperties.MODEL, TextUtils.res("block/leaf_feast")))
                                .select(LeafFeastTypes.TIP, Variant.variant().with(VariantProperties.MODEL, TextUtils.res("block/leaf_feast_tip")))
    ...
    private static void registerLeafFeastVariant(Block block, ModelTemplate modelTemplateBase, ModelTemplate modelTemplateTip, ModelTemplate modelTemplateEnd, ModelTemplate modelTemplateMiddle, BlockModelGenerators blockStateModelGenerator) {
        ...
        blockStateModelGenerator.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block)
                .with(BlockModelGenerators.createHorizontalFacingDispatch())
                .with(PropertyDispatch.property(LeafFeastBlock.LEAF_FEAST_TYPE)
                        .select(LeafFeastTypes.BASE, Variant.variant().with(VariantProperties.MODEL, templateLeafFeast))
                        .select(LeafFeastTypes.TIP, Variant.variant().with(VariantProperties.MODEL, templateLeafFeastTip))
                        .select(LeafFeastTypes.END, Variant.variant().with(VariantProperties.MODEL, templateLeafFeastEnd))
                        .select(LeafFeastTypes.MIDDLE, Variant.variant().with(VariantProperties.MODEL, templateLeafFeastMiddle))
        ));
    }
}
