...
public class BakingMatRecipeJsonBuilder implements CraftingRecipeJsonBuilder  {
    ...
    public void offerTo(Consumer<RecipeJsonProvider> exporter, Identifier recipeId) {
        ...
        exporter.accept(new BakingMatRecipeJsonProvider(new Identifier(recipeId.getNamespace(),prefix + recipeId.getPath()), this.ingredientList, this.processStages, this.resultList, this.tool, this.soundEventID, this.advancementBuilder, new Identifier(recipeId.getNamespace(),"recipes/" + prefix + recipeId.getPath())));
    }
    ...
    public static class BakingMatRecipeJsonProvider implements RecipeJsonProvider {
