...
public class CuttingBoardRecipeJsonBuilder implements CraftingRecipeJsonBuilder {
    ...
    public void offerTo(Consumer<RecipeJsonProvider> exporter, Identifier recipeId) {
        ...
        exporter.accept(new CuttingBoardRecipeJsonProvider(new Identifier(recipeId.getNamespace(),fdCuttingPrefix + recipeId.getPath()), this.results, this.ingredient, this.tool, this.soundEventID, this.advancementBuilder, new Identifier(recipeId.getNamespace(),"recipes/" + fdCuttingPrefix + recipeId.getPath())));
    }
