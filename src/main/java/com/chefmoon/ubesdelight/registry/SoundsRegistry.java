...
public enum SoundsRegistry {
    ...
    SoundsRegistry(String pathName) {
        ...
        this.soundEvent = new SoundEvent(new Identifier(UbesDelightMod.MOD_ID, this.pathName));
    }

    public static void registerAll() {
        for (SoundsRegistry value : values()) {
            Registry.register(Registry.SOUND_EVENT, new Identifier(UbesDelightMod.MOD_ID, value.pathName), value.soundEvent);
        }
    }
