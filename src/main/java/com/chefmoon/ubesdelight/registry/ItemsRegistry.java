...
public enum ItemsRegistry {
    ...
    LECHE_FLAN("leche_flan", () -> new UDConsumableItem(foodBase(FoodItem.LECHE_FLAN.get())), null, .85f),
    ...
    //Baking Stages
    POLVORONE_STAGE0("polvorone_stage0", () -> new Item(baseStage())),
    POLVORONE_STAGE1("polvorone_stage1", () -> new Item(baseStage())),
    POLVORONE_STAGE2("polvorone_stage2", () -> new Item(baseStage())),
    POLVORONE_PINIPIG_STAGE0("polvorone_pinipig_stage0", () -> new Item(baseStage())),
    POLVORONE_PINIPIG_STAGE1("polvorone_pinipig_stage1", () -> new Item(baseStage())),
    POLVORONE_PINIPIG_STAGE2("polvorone_pinipig_stage2", () -> new Item(baseStage())),
    POLVORONE_UBE_STAGE0("polvorone_ube_stage0", () -> new Item(baseStage())),
    POLVORONE_UBE_STAGE1("polvorone_ube_stage1", () -> new Item(baseStage())),
    POLVORONE_UBE_STAGE2("polvorone_ube_stage2", () -> new Item(baseStage())),
    POLVORONE_CC_STAGE0("polvorone_cc_stage0", () -> new Item(baseStage())),
    POLVORONE_CC_STAGE1("polvorone_cc_stage1", () -> new Item(baseStage())),
    POLVORONE_CC_STAGE2("polvorone_cc_stage2", () -> new Item(baseStage())),

    PANDESAL_STAGE0("pandesal_stage0", () -> new Item(baseStage())),
    PANDESAL_STAGE1("pandesal_stage1", () -> new Item(baseStage())),
    PANDESAL_STAGE2("pandesal_stage2", () -> new Item(baseStage())),
    PANDESAL_UBE_STAGE0("pandesal_ube_stage0", () -> new Item(baseStage())),
    PANDESAL_UBE_STAGE1("pandesal_ube_stage1", () -> new Item(baseStage())),
    PANDESAL_UBE_STAGE2("pandesal_ube_stage2", () -> new Item(baseStage())),
    ENSAYMADA_STAGE0("ensaymada_stage0", () -> new Item(baseStage())),
    ENSAYMADA_STAGE1("ensaymada_stage1", () -> new Item(baseStage())),
    ENSAYMADA_STAGE2("ensaymada_stage2", () -> new Item(baseStage())),
    ENSAYMADA_STAGE3("ensaymada_stage3", () -> new Item(baseStage())),
    ENSAYMADA_UBE_STAGE0("ensaymada_ube_stage0", () -> new Item(baseStage())),
    ENSAYMADA_UBE_STAGE1("ensaymada_ube_stage1", () -> new Item(baseStage())),
    ENSAYMADA_UBE_STAGE2("ensaymada_ube_stage2", () -> new Item(baseStage())),
    ENSAYMADA_UBE_STAGE3("ensaymada_ube_stage3", () -> new Item(baseStage())),
    HOPIA_MUNGGO_STAGE0("hopia_munggo_stage0", () -> new Item(baseStage())),
    HOPIA_MUNGGO_STAGE1("hopia_munggo_stage1", () -> new Item(baseStage())),
    HOPIA_MUNGGO_STAGE2("hopia_munggo_stage2", () -> new Item(baseStage())),
    HOPIA_UBE_STAGE0("hopia_ube_stage0", () -> new Item(baseStage())),
    HOPIA_UBE_STAGE1("hopia_ube_stage1", () -> new Item(baseStage())),
    HOPIA_UBE_STAGE2("hopia_ube_stage2", () -> new Item(baseStage()))
    ...
    ItemsRegistry(String pathName, Supplier<Item> itemSupplier) {
        this(pathName, itemSupplier, null, null);
    }
    ...
    private static FabricItemSettings base() {
        return new FabricItemSettings().group(UbesDelightMod.ITEM_GROUP);
    }
    private static FabricItemSettings baseStage() { return new FabricItemSettings(); }
    private static FabricItemSettings noStack() {
        return new FabricItemSettings().group(UbesDelightMod.ITEM_GROUP).maxCount(1);
    }
    private static FabricItemSettings foodBase(FoodComponent food) {
        return new FabricItemSettings().group(UbesDelightMod.ITEM_GROUP).food(food);
    }
    private static FabricItemSettings food(FoodComponent food) {
        return new FabricItemSettings().group(UbesDelightMod.ITEM_GROUP).food(food).recipeRemainder(Items.AIR);
    }
    private static FabricItemSettings food(FoodComponent food, Item remainder, int maxCount) {
        return new FabricItemSettings().group(UbesDelightMod.ITEM_GROUP).food(food).recipeRemainder(remainder).maxCount(maxCount);
    }
}
