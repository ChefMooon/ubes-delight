...
public class FoodValues {
    ...
    public static final FoodProperties FISH_SAUCE_BOTTLE = foodProperty(0, 0.0F,
            false, false, false, List.of(new MobEffectInfo(MobEffects.DOLPHINS_GRACE, SHORT_DURATION, 1.0F)));

    public static final FoodProperties MILK_TEA_UBE = foodProperty(0, 0.0F,
            true, false, false, List.of(new MobEffectInfo(MobEffects.NIGHT_VISION, SHORT_DURATION, 1.0F)));
    public static final FoodProperties HALO_HALO = foodProperty(0, 0.0F,
            true, false, false, List.of(new MobEffectInfo(NOURISHMENT, MEDIUM_DURATION, 1.0F)));
    ...
    public static final FoodProperties UBE_CAKE_SLICE = foodProperty(2, 0.1F,
            false, true, false, List.of(new MobEffectInfo(MobEffects.NIGHT_VISION, BRIEF_DURATION, 1.0F)));
