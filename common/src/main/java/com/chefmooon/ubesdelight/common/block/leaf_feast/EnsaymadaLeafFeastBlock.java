...
public class EnsaymadaLeafFeastBlock extends SimpleLeafFeastBlock {
    ...
    public static HashMap<LeafFeastTypes, HashMap<Integer, VoxelShape>> buildShapes() {
        ...
        baseServingShapes.put(1, UbesDelightShapes.ENSAYMADA_BASE_SERVING_1);
        baseServingShapes.put(2, UbesDelightShapes.ENSAYMADA_BASE_SERVING_2);
        baseServingShapes.put(3, UbesDelightShapes.ENSAYMADA_BASE_SERVING_3);
        baseServingShapes.put(4, UbesDelightShapes.ENSAYMADA_BASE_SERVING_4);
        baseServingShapes.put(5, UbesDelightShapes.ENSAYMADA_BASE_SERVING_5);
        baseServingShapes.put(6, UbesDelightShapes.ENSAYMADA_BASE_SERVING_6);
