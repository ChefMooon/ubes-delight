...
public class VillagerTrades extends FabricDynamicRegistryProvider {
    ...
    public static void onVillagerTrades(final BootstrapContext<VillagerTrade> context) {
        context.register(FARMER_1_UBE_EMERALD, emeraldsForItemsTrade(UbesDelightItemsImpl.UBE.get(), 3, 16, 2));
        context.register(FARMER_1_GARLIC_EMERALD, emeraldsForItemsTrade(UbesDelightItemsImpl.GARLIC.get(), 3, 16, 2));
        context.register(FARMER_1_GINGER_EMERALD, emeraldsForItemsTrade(UbesDelightItemsImpl.GINGER.get(), 3, 16, 2));
        context.register(FARMER_1_LEMONGRASS_EMERALD, emeraldsForItemsTrade(UbesDelightItemsImpl.LEMONGRASS.get(), 3, 16, 2));
    }

    public static void onWanderingTraderTrades(final BootstrapContext<VillagerTrade> context) {
        context.register(WANDERING_TRADER_UBE_EMERALD, itemForEmeraldTrade(UbesDelightItemsImpl.UBE.get(), 8, 5));
        context.register(WANDERING_TRADER_GARLIC_EMERALD, itemForEmeraldTrade(UbesDelightItemsImpl.GARLIC.get(), 8, 5));
        context.register(WANDERING_TRADER_GINGER_EMERALD, itemForEmeraldTrade(UbesDelightItemsImpl.GINGER.get(), 8, 5));
        context.register(WANDERING_TRADER_LEMONGRASS_EMERALD, itemForEmeraldTrade(UbesDelightItemsImpl.LEMONGRASS.get(), 8, 5));
    }
