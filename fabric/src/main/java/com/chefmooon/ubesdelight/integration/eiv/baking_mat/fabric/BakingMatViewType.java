...
public class BakingMatViewType implements IEivRecipeViewType {
    ...
    public ResourceLocation getId() {
        return ResourceLocation.withDefaultNamespace("baking_mat");
    }

    @Override
    public ItemStack getIcon() {
        return UbesDelightItemsImpl.BAKING_MAT_BAMBOO.get().getDefaultInstance();
    }
