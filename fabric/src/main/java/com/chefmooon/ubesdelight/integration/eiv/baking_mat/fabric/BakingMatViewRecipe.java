...
public class BakingMatViewRecipe implements IEivViewRecipe {
    ...
    public interface BakingMatSlotRenderer {
        ResourceLocation TEXTURE = TextUtils.res("textures/gui/emi/baking_mat.png");

        RecipeViewMenu.OptionalSlotRenderer DEFAULT = (guiGraphics, mouseX, mouseY, partialTicks) -> guiGraphics.blit(RenderType::guiTextured, TEXTURE, 0, 0, 0, 80, 18 ,18, 256, 256);
        RecipeViewMenu.OptionalSlotRenderer CHANCE = (guiGraphics, mouseX, mouseY, partialTicks) -> guiGraphics.blit(RenderType::guiTextured, TEXTURE, 0, 0, 18, 80, 18 ,18, 256, 256);
