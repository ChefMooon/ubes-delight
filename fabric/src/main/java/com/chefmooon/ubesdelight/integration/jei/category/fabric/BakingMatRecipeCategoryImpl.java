...
public class BakingMatRecipeCategoryImpl implements IRecipeCategory<RecipeHolder<BakingMatRecipeImpl>> {
    ...
    public BakingMatRecipeCategoryImpl(IGuiHelper helper) {
        ...
        icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(UbesDelightItemsImpl.BAKING_MAT_BAMBOO.get()));
    }

    @Override
    public IRecipeType<RecipeHolder<BakingMatRecipeImpl>> getRecipeType() {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<BakingMatRecipeImpl> holder, IFocusGroup focusGroup) {
        BakingMatRecipeImpl recipe = holder.value();
    ...
    @Override
    public void draw(RecipeHolder<BakingMatRecipeImpl> holder, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        BakingMatRecipeImpl recipe = holder.value();
